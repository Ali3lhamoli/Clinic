    ...
    <div class="container pb-5">
        <div class="row gap-2">
            ...
            <div class="col-sm order-sm-1">
                ...
                <p>Get reliable answers from healthcare professionals 24/7. 
                    Ask your questions and receive trusted medical advice for a healthier, safer life.
                </p>
            </div>
        </div>
    </div>
        ...
        @foreach ($majors as $major)
            <div class="card p-2" style="width: 18rem;">
                ...
                <div class="card-body d-flex flex-column gap-1 justify-content-center">
                    ...
                    <a href="{{ route('site.doctors', ['major_id' => $major->id]) }}" class="btn btn-outline-primary card-button">Browse Doctors</a>
                </div>
            </div>  
        @endforeach
    </div>
