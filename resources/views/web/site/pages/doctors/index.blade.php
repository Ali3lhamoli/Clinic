    ...
    <div class="doctors-grid">
        ...
        @foreach ($doctors as $doctor)
            <div class="card p-2" style="width: 18rem;">
                <img src="{{get_file_url($doctor->user->image)}}" class="card-img-top rounded-circle card-image-circle"
                    alt="major">
                <div class="card-body d-flex flex-column gap-1 justify-content-center">
                    ...
                    <a href="{{route('site.doctors.doctor', ['doctor_id'=>$doctor->user->id, 'major'=>$major->title])}}" class="btn btn-outline-primary card-button">Book an
                        appointment</a>
                </div>
            </div>
        @endforeach
